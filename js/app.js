...
async function tryThreeCake(host) { if (REDUCED) return false; try { const m = await import("./cake3d.js?v=10"); await m.mountCake3D(host, "AMEENA"); return true; } catch (_) { return false; } }
